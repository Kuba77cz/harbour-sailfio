...
CXXFLAGS      = -pipe -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -fmessage-length=0 -march=armv7-a -mfloat-abi=hard -mfpu=neon -mthumb -Wno-psabi -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtQuick -isystem /usr/include/qt5/QtGui -isystem /usr/include/qt5/QtQml -isystem /usr/include/qt5/QtNetwork -isystem /usr/include/qt5/QtCore -I. -I/usr/share/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = harbour-sailfio1.0.0
DISTDIR = /home/kuba/dev/sf/harbour-sailfio/.tmp/harbour-sailfio1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       =  
OBJECTS       = 
DIST          = qml/harbour-sailfio.qml \
		qml/TokenRemove.qml \
		qml/TokensList.qml \
		qml/About.qml \
		qml/main.js \
		rpm/harbour-sailfio.changes.in \
		rpm/harbour-sailfio.changes.run.in \
		rpm/harbour-sailfio.spec \
		rpm/harbour-sailfio.yaml \
		translations/*.ts \
		harbour-sailfio.desktop \
		...
		/usr/share/qt5/mkspecs/features/sailfishapp_qml.prf \
		...
		harbour-sailfio.pro  
QMAKE_TARGET  = harbour-sailfio
DESTDIR       = 
TARGET        = harbour-sailfio
TARGETA       = 
TARGET0       = 
TARGETD       = 
TARGET1       = 
...
Makefile: harbour-sailfio.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/sanitize.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
install_qm: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-sailfio/translations || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-sailfio/translations
	lupdate -noobsolete /home/kuba/dev/sf/harbour-sailfio/qml -ts /home/kuba/dev/sf/harbour-sailfio/translations/harbour-sailfio.ts && mkdir -p translations && [ "/home/kuba/dev/sf/harbour-sailfio" != "/home/kuba/dev/sf/harbour-sailfio" -a 0 -eq 1 ] && cp -af /home/kuba/dev/sf/harbour-sailfio/translations || : ; [ 0 -eq 1 ] && lrelease -nounfinished || :


install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-sailfio || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-sailfio
	-$(INSTALL_DIR) /home/kuba/dev/sf/harbour-sailfio/qml $(INSTALL_ROOT)/usr/share/harbour-sailfio/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-sailfio/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-sailfio/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_FILE) /home/kuba/dev/sf/harbour-sailfio/harbour-sailfio.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-sailfio.desktop
...
install_icon86x86: first FORCE
	...
	-$(INSTALL_FILE) /home/kuba/dev/sf/harbour-sailfio/icons/86x86/harbour-sailfio.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/

uninstall_icon86x86: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-sailfio.png
...
install_icon108x108: first FORCE
	...
	-$(INSTALL_FILE) /home/kuba/dev/sf/harbour-sailfio/icons/108x108/harbour-sailfio.png $(INSTALL_ROOT)/usr/share/icons/hicolor/108x108/apps/

uninstall_icon108x108: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/108x108/apps/harbour-sailfio.png
...
install_icon128x128: first FORCE
	...
	-$(INSTALL_FILE) /home/kuba/dev/sf/harbour-sailfio/icons/128x128/harbour-sailfio.png $(INSTALL_ROOT)/usr/share/icons/hicolor/128x128/apps/

uninstall_icon128x128: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/128x128/apps/harbour-sailfio.png
...
install_icon172x172: first FORCE
	...
	-$(INSTALL_FILE) /home/kuba/dev/sf/harbour-sailfio/icons/172x172/harbour-sailfio.png $(INSTALL_ROOT)/usr/share/icons/hicolor/172x172/apps/

uninstall_icon172x172: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/172x172/apps/harbour-sailfio.png
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/icons/hicolor/172x172/apps/ 


install: install_qm install_qml install_desktop install_icon86x86 install_icon108x108 install_icon128x128 install_icon172x172  FORCE

uninstall: uninstall_qml uninstall_desktop uninstall_icon86x86 uninstall_icon108x108 uninstall_icon128x128 uninstall_icon172x172  FORCE
